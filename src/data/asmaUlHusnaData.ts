// Asma-ul-Husna (99 Beautiful Names of Allah) with Turkish meanings
...
// Complete 99 Beautiful Names of Allah
export const asmaUlHusnaNames: AsmaUlHusnaName[] = [
  {
    id: 1,
    arabic: 'الرَّحْمَنُ',
    transliteration: 'Ar-Rahman',
    transliterationTr: 'Er-Rahman',
  ...
  },
  {
    ...
    transliterationTr: 'El-Melik',
    meaning: 'The King',
    meaningTr: 'Malik (Kral)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Kuddus',
    meaning: 'The Most Holy',
    meaningTr: 'Kuddus (Mukaddes)',
  ...
  },
  {
    ...
    transliterationTr: 'Es-Selam',
    meaning: 'The Source of Peace',
    meaningTr: 'Selam (Barış Kaynağı)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Mü\'min',
    meaning: 'The Giver of Security',
    meaningTr: 'Mü\'min (Güven Veren)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Müheymin',
    meaning: 'The Guardian',
    meaningTr: 'Müheymin (Koruyucu)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Aziz',
    meaning: 'The Mighty',
    meaningTr: 'Aziz (Güçlü)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Cebbar',
    meaning: 'The Compeller',
    meaningTr: 'Cebbar (Zorlayıcı)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Mütekebbir',
    meaning: 'The Supreme',
    meaningTr: 'Mütekebbir (Yüce)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Halik',
    meaning: 'The Creator',
    meaningTr: 'Halik (Yaratıcı)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Bari',
    meaning: 'The Evolver',
    meaningTr: 'Bari (Yaratıp Şekillendiren)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Musavvir',
    meaning: 'The Fashioner',
    meaningTr: 'Musavvir (Şekil Veren)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Gaffar',
    meaning: 'The Great Forgiver',
    meaningTr: 'Gaffar (Çok Bağışlayan)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Kahhar',
    meaning: 'The Subduer',
    meaningTr: 'Kahhar (Galip Gelen)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Vehhab',
    meaning: 'The Bestower',
    meaningTr: 'Vehhab (Çok Veren)',
  ...
  },
  {
    ...
    transliterationTr: 'Er-Rezzak',
    meaning: 'The Provider',
    meaningTr: 'Rezzak (Rızık Veren)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Fettah',
    meaning: 'The Opener',
    meaningTr: 'Fettah (Açan)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Alim',
    meaning: 'The All-Knowing',
    meaningTr: 'Alim (Her Şeyi Bilen)',
  ...
  },
  {
    ...
    transliterationTr: 'El-Kabız',
    meaning: 'The Withholder',
    meaningTr: 'Kabız (Sıkıştıran)',
...
export const getAllAsmaUlHusna = (): AsmaUlHusnaName[] => {
  return asmaUlHusnaNames;
};
